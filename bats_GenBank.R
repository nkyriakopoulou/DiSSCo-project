...
#In order to trace the sequences back to their physical objects we need institution codes and/or collection codes and for this reason,
#we should check the type of format used for the specimen vouchers.
...
#[7] "sparcle"         "genome"          "annotinfo"       "assembly"        "bioproject"      "biosample"      
#[13] "blastdbinfo"     "books"           "cdd"             "clinvar"         "gap"             "gapplus"        
#[19] "grasp"           "dbvar"           "gene"            "gds"             "geoprofiles"     "homologene"     
#[25] "medgen"          "mesh"            "ncbisearch"      "nlmcatalog"      "omim"            "orgtrack"       
#[31] "pmc"             "popset"          "proteinclusters" "pcassay"         "biosystems"      "pccompound"     
...
results <- sapply(dput(as.character(accessions)), entrez_search, db = "nuccore", simplify = FALSE) #List of 128 elements

ids <- lapply(results, "[[", "ids") #list of 128
...
#The samples were obtained from vouchered bat specimens during previous studies in several locations. Additional swab samples
#were collected from several synanthropic bat species on Madagascar. According to the summaries downloaded from GenBank, the 
#field "subname" contains source modifiers such as "isolate" (Individual isolate from which sample was obtained) and "host" 
#(Natural host (organism) from which sample was obtained) but these source modifiers indicate viral source material and not
#material that has been stored in a museum or a collection (https://www.ncbi.nlm.nih.gov/books/NBK53701/#gbankquickstart.what_kind_of_source_info_3).
#In this paper, since some of the virus material studied was extracted from vouchered specimens, it is relevant to examine
#the source modifiers available.

#Can we extract the isolates and hosts we got from GenBank and are found in the column "subname"?
...
#[1] "19020"  "19037"  "19028"  "19031"  "19032"  "19030"  "19026"  "19027"  "18990"  "18991"  "18992"  "19013"  "19004"  "19024"  "19015"  "19006" 
#[17] "18958"  "18996"  "19154"  "19174"  "19183"  "18997"  "18993"  "19185"  "19002"  "18951"  "18987"  "015"    "051"    "025"    "027"    "004"   
#...
...
#from vouchered specimens, the identifiers could represent actual specimen vouchers.
#According to GenBank (https://www.ncbi.nlm.nih.gov/books/NBK53701/#gbankquickstart.what_kind_of_source_info_3)
#the source modifiers bio_material, culture_collection and specimen_voucher are provided "only if the sequence 
#submitted was obtained from a sample retrieved directly from the indicated museum/collection, or the sequence
#was obtained from a sample that the submitter deposited in the indicated museum/collection", so these sequences
#could have specimen vouchers.
